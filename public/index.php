            ...
            if ($event['type'] == 'message') {
                if ($event['message']['type'] == 'text') {
                    ...
                    if (lcfirst($event['message']['text']) == 'stiker') {
                        ...
                        // send text
                        $audioMessageBuilder  = new AudioMessageBuilder('https://dl.orangedox.com/CxrfbH', '4:21');
